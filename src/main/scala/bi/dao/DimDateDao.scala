 ...
 */
object DimDateDao extends EntityActions with PostgresProfileProvider {
  ...
  type Id = Long;
  type Entity = Tables.DimEvaluationRow
  type EntityTable = Tables.DimEvaluation
  val tableQuery = Tables.DimEvaluation
