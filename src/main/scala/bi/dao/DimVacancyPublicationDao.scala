 ...
 */
object DimVacancyPublicationDao extends EntityActions with PostgresProfileProvider {
  ...
  type Id = Long;
  type Entity = Tables.DimVacancyPublicationRow
  type EntityTable = Tables.DimVacancyPublication
  val tableQuery = Tables.DimVacancyPublication
