 ...
 */
object DimPoolDao extends EntityActions with PostgresProfileProvider {
  ...
  type Id = Long;
  type Entity = Tables.DimJobPlatformRow
  type EntityTable = Tables.DimJobPlatform
  val tableQuery = Tables.DimJobPlatform
