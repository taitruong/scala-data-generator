 ...
 */
object DimRecruiterDao extends EntityActions with PostgresProfileProvider {
  ...
  type Id = Long;
  type Entity = Tables.DimRecruiterRow
  type EntityTable = Tables.DimRecruiter
  val tableQuery = Tables.DimRecruiter
