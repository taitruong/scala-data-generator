 ...
 */
object DimVacancyStatusDao extends EntityActions with PostgresProfileProvider {
  ...
  type Id = Long;
  type Entity = Tables.DimVacancyStatusRow
  type EntityTable = Tables.DimVacancyStatus
  val tableQuery = Tables.DimVacancyStatus
