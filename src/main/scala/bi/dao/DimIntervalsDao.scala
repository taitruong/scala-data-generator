 ...
 */
object DimIntervalsDao extends EntityActions with PostgresProfileProvider {
  ...
  type Id = Long;
  type Entity = Tables.DimIntervalsRow
  type EntityTable = Tables.DimIntervals
  val tableQuery = Tables.DimIntervals
