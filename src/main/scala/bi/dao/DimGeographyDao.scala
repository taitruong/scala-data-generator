 ...
 */
object DimGeographyDao extends EntityActions with PostgresProfileProvider {
  ...
  type Id = Long;
  type Entity = Tables.DimGeographyRow
  type EntityTable = Tables.DimGeography
  val tableQuery = Tables.DimGeography
