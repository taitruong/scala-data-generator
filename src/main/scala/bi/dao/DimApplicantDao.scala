 ...
 */
object DimApplicantDao extends EntityActions with PostgresProfileProvider {
  ...
  type Id = Long;
  type Entity = Tables.DimApplicantRow
  type EntityTable = Tables.DimApplicant
  val tableQuery = Tables.DimApplicant
