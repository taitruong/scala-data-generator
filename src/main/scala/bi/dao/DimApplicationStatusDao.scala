 ...
 */
object DimApplicationStatusDao extends EntityActions with PostgresProfileProvider {
  ...
  type Id = Long;
  type Entity = Tables.DimApplicationStatusRow
  type EntityTable = Tables.DimApplicationStatus
  val tableQuery = Tables.DimApplicationStatus
