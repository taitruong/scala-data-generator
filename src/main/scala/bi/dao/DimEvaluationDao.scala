 ...
 */
object DimEvaluationDao extends EntityActions with PostgresProfileProvider {
  ...
  type Id = Long;
  type Entity = Tables.DimDateRow
  type EntityTable = Tables.DimDate
  val tableQuery = Tables.DimDate
