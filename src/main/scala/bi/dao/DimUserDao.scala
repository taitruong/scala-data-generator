 ...
 */
object DimUserDao extends EntityActions with PostgresProfileProvider {
  ...
  type Id = Long;
  type Entity = Tables.DimUserRow
  type EntityTable = Tables.DimUser
  val tableQuery = Tables.DimUser
